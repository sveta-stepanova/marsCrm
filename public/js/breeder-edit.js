...
(function () {
	...
	(0, _jquery2.default)(function () {
		...
		$FamilyTree.uploadFile({
			...
			onSuccess: function onSuccess(req, res) {
				uploading = false;
		...
		// {{{ Breeds
		var $breeds = (0, _jquery2.default)('#Breeds tbody'),
		...
		_jquery2.default.ajax('/register/breeds', { success: function success(res) {
				...
				if ($breeds.data('breeds')) {
					...
					existingBreeds.forEach(function (existingBreed, i) {
						var $formRow = $breeds.find('tr').slice(i, i + 1),
		...
		$breedSelects.change(function (e) {
			var $this = (0, _jquery2.default)(e.target),
			    ...
			    $quantity = (0, _jquery2.default)($breedDetails[0]),
			    $weight = (0, _jquery2.default)($breedDetails[1]);
			selectedBreedIds = [];
		...
		$breeds.find('input[id*=Quantity], input[id*=Weight]').change(function (e) {
			...
			$msgOutput.html("70% \u043E\u0442 \u043E\u0431\u0449\u0435\u0439 \u043F\u043E\u0442\u0440\u0435\u0431\u043D\u043E\u0441\u0442\u0438 \u0432\u0430\u0448\u0435\u0433\u043E \u043F\u043E\u0433\u043E\u043B\u043E\u0432\u044C\u044F \u0441\u043E\u0441\u0442\u0430\u0432\u043B\u044F\u044E\u0442 " + Math.round(10 * monthlyConsumption) / 10 + " \u043A\u0433. \u043A\u043E\u0440\u043C\u0430 Pedigree\xAE \u0432 \u043C\u0435\u0441\u044F\u0446");
		});
		// }}}
	});
}).call(window);
